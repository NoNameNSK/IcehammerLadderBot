...
public class IcehammerLadderBot extends TelegramLongPollingBot {
    ...
    private boolean isValidResult(String messageText) {
        return MatchResult.isValidResult(messageText);
    }
